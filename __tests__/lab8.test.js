describe('Basic user flow for Website', () => {
  ...
  it('Clicking the "Add to Cart" button should change button text', async () => {
    ...
    let innerButtonText = await shadowButton.getProperty("innerText");
    // Once you have the innerText property, use innerText.jsonValue() to get the text value of it
    let innerButtonTextVal = await innerButtonText.jsonValue();
    expect(innerButtonTextVal).toBe("Remove from Cart");
  }, 2500);
  ...
  it('Checking number of items in cart on screen', async () => {
    ...
    const cartCountVal = await cartCount.jsonValue();
  ...
  it('Checking number of items in cart on screen after reload', async () => {
    ...
    for (let i = 1; i < prodItems.length; i++) {
      const shadowRoot = await prodItems[i].getProperty("shadowRoot");
      const shadowButton = await shadowRoot.$("button");
      const innerButtonText = await shadowButton.getProperty("innerText");
      let innerButtonTextVal = await innerButtonText.jsonValue();
      expect(innerButtonTextVal).toBe("Remove from Cart");
    };
  ...
  it('Checking number of items in cart on screen after reload', async () => {
    ...
    for (let i = 0; i < prodItems.length; i++) {
      ...
      const innerButtonText = await shadowButton.getProperty("innerText");
      let innerButtonTextVal = await innerButtonText.jsonValue();
      expect(innerButtonTextVal).toBe("Add to Cart");
    };
